...
namespace UnitTest
{
  public partial class TestCases
  {
	...
	string strCreateTable = string.Format ("CREATE TABLE {0}(id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, f_int INT)",
					       testTable);
	...
	try
	  {
	    String strConn3 =
		    @"Dsn=CUBRID_ODBC;db_name=test_odbc;uid=invlid_uid;pwd=;server=test-db-server;port=33000;fetch_size=100";
	...
	try
	  {
	    String strConn3 =
		    @"Dsn=CUBRID_ODBC;db_name=test_odbc;uid=invlid_uid;pwd=;server=test-db-server;port=330001;fetch_size=100";
	    OdbcConnection connCubrid3 = new OdbcConnection (strConn3);
	    connCubrid3.Open();
	    connCubrid3.Close();
	  }
